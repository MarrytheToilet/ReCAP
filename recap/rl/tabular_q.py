...
PriorMode = Literal["none", "prior-soft", "prior-hard"]
...
def train_q_learning(
    ...
    if config.prior != "none" and controller is None:
        raise ValueError("controller is required when using an ReCAP prior")
...
def run_training_episode(
    ...
    config: QLearningConfig,
    rng: random.Random,
    controller: PriorController | None,
) -> EpisodeTrace:
