...
from recap.agents.learned_reranker_agent import load_reranker_model
from recap.agents.intervention_verifier import LLMInterventionVerifier, VerifierConfig
from recap.models.intervention_gate import load_gate_model
from recap.agents.preference_agent import load_action_preferences
...
from recap.probe.trace_feedback import load_trace_feedback


def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate simple agents with optional ReCAP control.")
    ...
    parser.add_argument(
        "--controller",
        choices=["none", "prior", "recap-replay", "recap-verified-proposal"],
        default="none",
    )
